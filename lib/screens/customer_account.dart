                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Table ${restaurantState.currentTableNumber} — Active Session",
                                style: const TextStyle(
...
<<<<<<< HEAD
                            ...
                            label: "Orders Placed",
                            value:
                                "${restaurantState.getOrdersForTable(restaurantState.currentTableNumber).length}",
                          ),
                          _buildSummaryRow(
                          ...
                          _buildSummaryRow(
                            ...
                            label: "Total Spent",
                            value:
                                "₹${restaurantState.getTableOrdersTotal(restaurantState.currentTableNumber).toStringAsFixed(0)}",
                          ),
                          _buildSummaryRow(
                            icon: Icons.room_service_outlined,
                            label: "Waiter Requested",
                            value: restaurantState.isWaiterRequested(
                                    restaurantState.currentTableNumber)
                                ? "Notified ✓"
                                : "No",
                            valueColor: restaurantState.isWaiterRequested(
                                    restaurantState.currentTableNumber)
                          ...
                          _buildSummaryRow(
                            ...
                            label: "Bill Status",
                            value: restaurantState.isBillRequested(
                                    restaurantState.currentTableNumber)
                                ? "Requested ✓"
                                : "Not Requested",
                            valueColor: restaurantState.isBillRequested(
                                    restaurantState.currentTableNumber)
                                ? CafeTheme.accentGreen
                                : CafeTheme.textMuted,
=======
...
<<<<<<< HEAD
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        label: const Text("Staff / Kitchen Access"),
  ...
  void _showAdminPinDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Column(
          children: [
            Icon(Icons.lock_outline, color: CafeTheme.primary, size: 36),
            SizedBox(height: 10),
            Text(
              'Staff Access',
              style: TextStyle(
